...
public class SearchResultsItemAdapter extends RecyclerView.Adapter<SearchResultsItemAdapter.ItemViewHolder>
{
    Context context;
    List<ItemModel> ls;

    public SearchResultsItemAdapter(Context context, List<ItemModel> ls) {
    ...
    @NonNull
    @Override
    public SearchResultsItemAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(@NonNull View itemView) {
            ...
            itemCard = itemView.findViewById(R.id.yourItemCard);
        }
    }
}
