...
public class YourItemAdapter extends RecyclerView.Adapter<YourItemAdapter.ItemViewHolder>
{
    private Context context;
    private List<ItemModel> ls;

    public YourItemAdapter(Context context, List<ItemModel> ls) {
    ...
    @NonNull
    @Override
    public YourItemAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
